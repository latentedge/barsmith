    ...
    Ok(vec![
        measure(
            BenchmarkSpec {
                ...
                fixture_label: "n=256,k=3,iterations=20000".to_string(),
                fixture_sha256: None,
                command: None,
            ...
            args,
            || rank_unrank_roundtrip(256, 3, 20_000),
        )?,
        measure(
            BenchmarkSpec {
                suite: "combinator".to_string(),
                ...
                fixture_tier: "synthetic".to_string(),
                fixture_label: "n=512,max_depth=3,iterations=5000000".to_string(),
                fixture_sha256: None,
                command: None,
            ...
            args,
            || iterate_indices(512, 3, 5_000_000),
        )?,
    ])
}
