...
/// Run the shared long/short backtest engine.
///
/// Each direction can have at most one open trade, and the next candidate
/// starts after the prior exit.
pub fn run_backtest(inputs: &BacktestInputs) -> BacktestOutputs {
    ...
    // Merge long and short trades into one chronological stream.
